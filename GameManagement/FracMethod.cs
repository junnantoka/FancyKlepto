...
namespace FancyKlepto
{
    ...
    {/*
        public static void Main()
        {
            ...
            Console.WriteLine("The fraction is {0}", dec2frac(Convert.ToDouble(Console.ReadLine())));
        }*/
        ...
        /// <returns></returns>
        public static string recur(string db)
        {
        ...
        /// <returns></returns>
        public static int occurence(string s, string check)
        {
            int i = 0;
            int d = s.Length;
            string ds = check;
        ...
        public static void reduceNo(int i, ref double rD, ref double rN)
        {
